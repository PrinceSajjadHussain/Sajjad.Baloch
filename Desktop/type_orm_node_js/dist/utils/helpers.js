...
exports.clients = exports.formatDateToCustomString = exports.generateUniqueId = void 0;
...
function convertToDate(dateString) {
    ...
    return new Date(parseInt(`20${year}`, 10), // Adding '20' to the year to convert '24' to '2024'
    monthIndex, parseInt(day, 10), hour, parseInt(minutes, 10), parseInt(seconds, 10), parseInt(milliseconds.slice(0, 3), 10) // Ensure milliseconds are three digits
    );
}
